...
> 运行态基线：`godot.log` L695 `--- RUNNING MODDED! --- Loaded 30 mods (35 total)` -- 35 注册 = 28 工坊订阅 + 7 本地；30 在载（RegentFX 用户禁用 + 双源去重禁 4，见 Sec 4）。
...
| BaseLib | BaseLib | v3.4.5 | 上游官方本地镜像（与工坊 3737335127 逐字节一致，**非 fork**，详 Sec 5） | 否 | 1,090,560 | 131,880 | 无 |
...
| RegentFemPortraits | 尖塔储君卡图娘化 | v0.6.0 | 第三方旧版本地副本（工坊 v1.0 更新但双源判负，见 Sec 4） | 否 | 24,576 | 48,593,496 | 无 |
| Mesugaki | Mesugaki_Regent | 0.1.1 | 第三方旧版本地副本（工坊 0.1.2 更新且胜出，**本地已被引擎禁用**，见 Sec 4） | 否 | 5,632 | 2,988,140 | 无 |
...
|---|---|---|---|---|---|---|---|---|
| 3737335127 | BaseLib | BaseLib | v3.4.5 | 否 | 1,090,560 | 131,880 | 无 | 双源判负->本地胜（Sec 4） |
| 3746969593 | ActsFromThePast | Acts from the Past | 1.0.5 | 是 | 1,125,888 | 110,327,596 | BaseLib >=v3.3.6 | 双源判负->本地 fork 胜（Sec 4） |
...
| 3747528152 | intentgraph2 | Intent Graph | 1.5.1 | 否 | 7,168 | 428,124 | 无 | 另含 core 306,176x2（含 lt-0.110.0 旧版）、baselib 8,192、ritsulib 14,336、Antlr4 192,000 |
...
| 3747751411 | RegentFemPortraits | 尖塔储君卡图娘化 | v1.0 | 否 | 24,576 | 63,826,568 | 无 | 双源判负（版本解析失败）->本地 v0.6.0 胜（Sec 4） |
...
| 3748603697 | Mesugaki | Mesugaki_Regent | 0.1.2 | 否 | 15,872 | 4,522,820 | 无 | **双源胜出**：本地 0.1.1 被禁（Sec 4） |
