...
| 4 | Burst 迸发 | 下 1 张->下 N 张技能牌(PowerVar +1) | 已有 `!BurstPower!` [x] | **缺变量** + **误译**:"非攻击牌"应为"**技能牌**"(官方:这个回合,你打出的下一张**技能牌**会打出两次) | "your next !M! **Skills** are played twice" |
