...
Verified directly against the shipped XML documentation, 2026-08-21. Supersedes the `JmcModLibScout` run, whose substantive verdict was right but whose provenance was wrong (see Sec 5).
...
| multiplayer | 33 | NO - compat shims only, see Sec 4 |
...
Its substantive verdict nevertheless holds, and Sec 2 above re-establishes it from the XML directly.
