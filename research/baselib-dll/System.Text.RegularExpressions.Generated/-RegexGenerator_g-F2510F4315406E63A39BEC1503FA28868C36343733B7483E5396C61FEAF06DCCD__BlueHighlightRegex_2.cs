...
[SkipLocalsInit]
internal sealed class _003CRegexGenerator_g_003EF2510F4315406E63A39BEC1503FA28868C36343733B7483E5396C61FEAF06DCCD__BlueHighlightRegex_2 : Regex
{
		...
		private sealed class Runner : RegexRunner
		{
			...
			private bool TryMatchAtCurrentPosition(ReadOnlySpan<char> inputSpan)
			{
				...
				while (true)
				{
					...
					span = inputSpan.Slice(num);
					char c;
					if (span.IsEmpty || (((c = span[0]) < '\u0080') ? (("㸀\0們\0\0\0\0\u3000"[(int)c >> 4] & (1 << (c & 0xF))) == 0) : (!RegexRunner.CharInClass(c, "\0\b\u0001$%,-./|~d"))))
					{
						UncaptureUntil(num7);
						if (_003CRegexGenerator_g_003EF2510F4315406E63A39BEC1503FA28868C36343733B7483E5396C61FEAF06DCCD__Utilities.s_hasTimeout)
						{
	...
	internal static readonly _003CRegexGenerator_g_003EF2510F4315406E63A39BEC1503FA28868C36343733B7483E5396C61FEAF06DCCD__BlueHighlightRegex_2 Instance = new _003CRegexGenerator_g_003EF2510F4315406E63A39BEC1503FA28868C36343733B7483E5396C61FEAF06DCCD__BlueHighlightRegex_2();

	private _003CRegexGenerator_g_003EF2510F4315406E63A39BEC1503FA28868C36343733B7483E5396C61FEAF06DCCD__BlueHighlightRegex_2()
	{
		pattern = "(?<=^|[^/])\\$({.+?}|.+?(?=$|[\\s$.,|}]))\\$?";
