...
[ScriptPath("res://src/Core/Nodes/Screens/Settings/NKeyboardOnlyModeTickbox.cs")]
public class NKeyboardOnlyModeTickbox : NSettingsTickbox, IResettableSettingNode
{
	/// <summary>
