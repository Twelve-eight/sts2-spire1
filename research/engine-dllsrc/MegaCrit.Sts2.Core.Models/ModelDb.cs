...
public static class ModelDb
{
	...
	/// </summary>
	public static IEnumerable<EncounterModel> EventEncounters => _eventEncounters ?? (_eventEncounters = new global::_003C_003Ez__ReadOnlyArray<EncounterModel>(new EncounterModel[5]
	{
