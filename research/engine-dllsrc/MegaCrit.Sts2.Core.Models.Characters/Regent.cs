...
public sealed class Regent : CharacterModel
{
	...
	protected override List<(AnimState, string)> AnimationStates => base.AnimationStates.Concat<(AnimState, string)>(new global::_003C_003Ez__ReadOnlySingleElementList<(AnimState, string)>((new AnimState("attack_sovereign"), "sovereignBladeTrigger"))).ToList();
