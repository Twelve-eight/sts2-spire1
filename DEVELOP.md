...
- Now: **M4 content is essentially complete. M2 monsters is the next milestone and is NO LONGER BLOCKED** (session 5 recon — see `DEVLOG.md` §5.1). All four characters, 306 card classes, 25 relics, 49 powers and 53 event classes build 0 errors and are deployed; every event branch that was blocked on a missing relic or card is wired. (Counts corrected 2026-08-30 per critic #13 and freeze-review: 306 cards, 25 relics after the 8 official-equivalent deletions of 2e405f8.)
...
| M4 (**DONE**) | 4 characters, 306 cards, 25 relics, 49 powers, potions, 53 events — deployed (counts corrected 2026-08-30) | build 0 errors; in-game smoke |
