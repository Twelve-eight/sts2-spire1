...
/// A Harmony postfix on GetBaseOdds - x3 when rarity==Rare, type==CombatReward, and the rolling
...
public class Nloth : Spire1Event
{
    ...
    protected override IReadOnlyList<EventOption> GenerateInitialOptions()
    {
        ...
        // Offers withheld pending the GetBaseOdds x3 odds hook (see class doc FLAG UPDATE).
        // StS1 form: "[Offer: <relic name>] Lose this relic. Obtain a special relic." x2 random
